...
#include <string.h> // ::tolower, ::toupper
#include <stdbool.h>
#include <stdio.h>
#include <ctype.h>
...
// namespace fts {
    ...
    static bool fuzzy_match_complex(char const * pattern, char const * str, int * outScore, uint8_t * matches, int maxMatches);
// }
...
// namespace fts {
    ...
    static bool fuzzy_match(char const * pattern, char const * str, int * outScore) {
        ...
        uint8_t matches[256];
        return fuzzy_match_complex(pattern, str, outScore, matches, sizeof(matches));
    }
